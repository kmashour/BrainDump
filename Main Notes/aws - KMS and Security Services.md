...
*Read more details in the atomic note: [[AWS Key Management Service]]*

---

## 📑 Secrets Manager vs. Parameter Store

*   **[[SSM Parameter Store]]:** A secure, hierarchical database for storing configuration parameters and secrets (passwords, database strings). Free for standard parameters; lacks automatic rotation.
...
*   **[[Amazon GuardDuty]]:** Managed continuous security monitoring and threat detection service. Analyzes CloudTrail, VPC Flow Logs, and DNS query logs out-of-band using machine learning to detect anomalies, unauthorized deployments, compromised hosts, and cryptocurrency mining.

*Read more in [[Reference Notes/3-3_aws_kms_security.md]]*
