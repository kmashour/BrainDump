...
**Breadcrumbs:** [[Main Notes/0-Index|🏠 Index]] > Workloads & Infrastructure > **serviceaccount**
...
FROM "Main Notes"
WHERE class = "deeper-dive" AND icontains(string(parent_concept), "serviceaccount")
SORT file.name ASC
```
