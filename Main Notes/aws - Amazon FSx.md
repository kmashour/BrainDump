...
### 2. FSx for Lustre
*   **Protocols:** Lustre high-performance client.
*   **Use Cases:** Machine Learning (ML), High-Performance Computing (HPC), video transcoding, and financial modeling.
*   **S3 Integration:** Bidirectional syncing with Amazon S3. Can read S3 datasets as active file systems, perform local cluster processing, and write outputs back to S3.
*   **Deployment Options:**
...
*   **Features:** Supports snapshots, compression, and point-in-time cloning. **Does not support data deduplication** (unlike ONTAP).
*   **Use Cases:** Lifting and shifting legacy ZFS file systems to AWS.

*Read more in [[Reference Notes/3-5_aws_ebs_efs_storage.md#8-amazon-fsx|Module 3-5: Amazon FSx]]*
