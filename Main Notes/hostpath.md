...
*Read more in [[Reference Notes/0-8-1_storage_primitives_emptydir_hostpath.md#1-volume-plugins-and-in-tree-types]] and [[Reference Notes/0-8-a_local_storage_models_and_scheduling_traps.md]]*