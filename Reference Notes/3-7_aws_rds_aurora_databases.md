...
# Module 3-7: AWS Relational Databases (RDS & Aurora) & DMS
...
## 2. Amazon Aurora Cloud-Native Database
AWS's relational database engine compatible with MySQL and PostgreSQL.

### A. Aurora Shared Storage Architecture
*   Replicates data across a virtual storage system spanning 3 AZs.
*   Aurora maintains **6 copies** of the data.
*   Uses Cluster, Reader, and Instance endpoints.

---

## 3. Database Migration: DMS & SCT
