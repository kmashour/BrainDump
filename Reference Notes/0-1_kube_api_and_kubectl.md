...
The `kube-apiserver` is the front gate to the control plane. For its architectural placement and role in High Availability (HA) topologies, see [Module 02: Cluster Architecture & Control Plane Components](0-2-1_control_plane_and_core_daemons.md#2-control-plane-core-components-deep-dive).
...
## 🔗 Related Modules
- [Module 02: Cluster Architecture & Control Plane Components](0-2-1_control_plane_and_core_daemons.md) - Deep dive into where the API server resides and how other control plane components talk to it.
