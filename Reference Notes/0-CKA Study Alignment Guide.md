...
| **4. App Lifecycle**        | Rolling updates, ConfigMaps, Secrets, initContainers | [[0-6-1_pod_lifecycle_probes_and_containers \| 0-6-1_pod_lifecycle_probes_and_containers.md]]<br>[[0-7-1_rbac_service_accounts_and_certificates \| 0-7-1_rbac_service_accounts_and_certificates.md]]                   | Deployment rolling update parameters (`maxSurge`/`maxUnavailable`) & rollbacks<br>ConfigMap/Secret injection (envs, files)                           |
...
| **6. Security**             | TLS certificates, RBAC, NetworkPolicies, Webhooks    | [[0-7-1_rbac_service_accounts_and_certificates \| 0-7-1_rbac_service_accounts_and_certificates.md]]<br>[[0-16_admission_controllers \| 0-16_admission_controllers.md]]                                               | TLS handshake, CA creation, Kubeconfig configs<br>RBAC binding, ServiceAccounts, NetworkPolicy rules<br>Admission webhooks, ImagePolicyWebhook setup |
| **7. Storage**              | PV, PVC, StorageClasses, CSI drivers                 | [[0-8-1_storage_primitives_emptydir_hostpath \| 0-8-1_storage_primitives_emptydir_hostpath.md]]                                                                                                                          | CSI architecture, PV bindings, Mount volumes                                                                                                         |
...
*   **Step 2.3:** Inject **State & Credentials**. Study [[0-7-1_rbac_service_accounts_and_certificates|0-7-1_rbac_service_accounts_and_certificates.md]] for ConfigMaps and Secrets, and how files/env-vars are projected into container runtimes.
...
*   **Step 4.1:** Study **Persistent Storage**. Read [[0-8-1_storage_primitives_emptydir_hostpath|0-8-1_storage_primitives_emptydir_hostpath.md]] to learn how PersistentVolumes bind to claims, the role of StorageClasses, and CSI controller plugin pipelines.
...
*   **Step 5.1:** Study **TLS, RBAC, and Policies**. Read [[0-7-1_rbac_service_accounts_and_certificates|0-7-1_rbac_service_accounts_and_certificates.md]] to understand X.509 cert chains, Role/ClusterRole bindings, securityContext user mappings, and NetworkPolicy ingress/egress CIDR blocks.
