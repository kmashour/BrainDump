...
**Breadcrumbs:** [[Digital Garden/0-Index|🏠 Index]] > Patterns > **Stateful Database Clustering in Kubernetes**
...
5. **Local Storage (LVM/hostPath) and Node Affinity**:
   ...
   * *See complete architectural breakdowns in [[Reference Notes/0-8-a_local_storage_models_and_scheduling_traps.md]] and hands-on scheduling deadlock simulation in [[Project - Local Storage Models and Scheduling Traps]].*
